% Produces wavenumber omnidirectional spectra from Elfouhaily et al. [1997]
% model, then computes "subpixel" root-mean-square slope originating from
% scales smaller than some cutoff scale
%
% N. Laxague 2024
%
...
% Compute cumulative and total mean square slope, then "subpixel" rms slope
