...
% Hm0 = 4*sqrt(var(eta,[],'all'));

%eta = eta(grid_size/2-framesize_reduced/2+1:grid_size/2+framesize_reduced/2,grid_size/2-framesize_reduced/2+1:grid_size/2+framesize_reduced/2,:)*Hs/Hm0/2;
eta = eta*Hs/Hm0/2;
